...
# ----------------------------
# 7) (Optional) MRM regression for distance matrices (accounts better than naïve lm)
# ----------------------------
# install.packages("ecodist")  # if needed
# library(ecodist)
# mrm_fit <- ecodist::MRM(as.dist(gen_dist) ~ as.dist(geo_dist_km), nperm = 9999)
# print(mrm_fit)
